...
│   │   ├── generate/route.js        # Supplier generation pipeline
│   │   └── embed/route.js           # Embedding generation service
│   │
│   ├── alternatives/                # Alternative view modes
│   │   └── page.js                  # Comparison interface
│   │
│   ├── predictor/                   # Analytics dashboard
│   │   └── page.js                  # Metrics & predictions
│   │
│   └── components/                  # Reusable UI Components
│       ├── Navigation.js             # Top navigation bar
│       ├── SupplierMapView.js        # Geospatial mapping interface
│       ├── CompanyIntelligenceCard.js # Supplier detail cards
│       └── ContactSupplierModal.js   # Contact engagement modal
│
├── 🧠 lib/                          # Core Business Logic
│   ├── searchEngine.js              # Semantic search implementation
│   ├── semanticEngine.js            # Embedding + similarity logic
│   ├── companyIntelligence.js       # Supplier scoring algorithm
│   ├── companyMetrics.js            # Analytics computation
│   ├── supplierNormalize.js         # Data standardization
│   └── outreachEmail.js             # Communication automation
│
├── 🐍 backend/                      # Python Intelligence Service
...
💬 **Give feedback** — Help us build the perfect tool  
